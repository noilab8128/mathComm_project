...
export default function LoginPage() {
    ...
    const handleGoogleLogin = async () => {
        try {
            setIsLoading(true);
            // NextAuth signIn will handle redirect to Google and back
                ...
                <CardContent className="space-y-4 pt-4">
                    ...
                    >
                        {isLoading ? (
                            ...
                            <svg
                                className="h-5 w-5 mr-2 absolute left-4"
                                aria-hidden="true"
                                viewBox="0 0 24 24"
                            >
                                <path
                        ...
                        <span className={isLoading ? "opacity-0" : ""}>Continue with Google</span>
                    </Button>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-white px-2 text-muted-foreground bg-gray-50">
                                Are you an admin?
                            </span>
                        </div>
                    </div>
                    <Link href="/top-secret" className="block">
                        <Button variant="ghost" className="w-full text-xs text-gray-400 font-normal hover:text-gray-600">
                            Secret Admin Login
                        </Button>
                    </Link>
